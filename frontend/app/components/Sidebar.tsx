...
const NAV_ITEMS: NavItem[] = [
  {
    route: "/(clerk)/dashboard" as RelativePathString,
    label: "Dashboard",
    icon: "\u229E",
  },
  {
    route: "/(clerk)/kanban" as RelativePathString,
    label: "Kanban Board",
    icon: "\u25A6",
  },
  {
    route: "/(clerk)/cases" as RelativePathString,
    label: "Cases",
    icon: "\u2261",
  },
  {
    route: "/(clerk)/new-case" as RelativePathString,
    label: "New Case",
    icon: "\uFF0B",
  },
];
...
export function Sidebar({ userName, userInitials, userDept }: SidebarProps) {
  ...
  return (
    <View style={styles.root}>
      ...
      <TouchableOpacity
        style={[styles.footer, pathname === "/profile" && styles.footerActive]}
        activeOpacity={0.7}
        onPress={() => router.push("/(clerk)/profile" as RelativePathString)}
      >
